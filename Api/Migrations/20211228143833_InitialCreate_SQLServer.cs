    ...
    public partial class InitialCreate_SQLServer : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "users",
                columns: new[] { "Id", "CreateDate", "Login", "Password", "UpdateDate" },
                values: new object[] { 1, new DateTime(2021, 12, 28, 11, 38, 33, 454, DateTimeKind.Local).AddTicks(2529), "admin", "admin", null });
